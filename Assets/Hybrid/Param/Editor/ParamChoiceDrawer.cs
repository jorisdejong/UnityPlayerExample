...
[CustomPropertyDrawer( typeof( ParamChoice ) )]
public class ParamChoiceDrawer : PropertyDrawer
{
    bool foldout;
    public override void OnGUI( Rect position, SerializedProperty property, GUIContent label )
    {
        ...
        //get the param
        var param = fieldInfo.GetValue( property.serializedObject.targetObject ) as ParamChoice;
        ...
        param.SetIndex( EditorGUI.Popup( rect, property.displayName, param.GetIndex(), param.choices ) );
        ...
        if ( foldout )
        {
            ...
            var choicesProperty = property.FindPropertyRelative( "choices" );
            rect.y += nextLine;
            rect.height = EditorGUI.GetPropertyHeight( choicesProperty );
            EditorGUI.PropertyField( rect, choicesProperty, true );

            rect.y += EditorGUI.GetPropertyHeight( choicesProperty );
    ...
    public override float GetPropertyHeight( SerializedProperty property, GUIContent label )
    {
        ...
        if ( foldout )
        {
            ...
            var choicesProperty = property.FindPropertyRelative( "choices" );
            height += EditorGUI.GetPropertyHeight( choicesProperty );
            var valueChanged = property.FindPropertyRelative( "valueChanged" );
